...
const CheckoutForm = ({ booking }) => {
    ...
    useEffect(() => {
        ...
        fetch("https://d-127-1-m-76-doctors-portal-server-nov-18.vercel.app/create-payment-intent", {
            method: "POST",
            headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        if (paymentIntent.status === "succeeded") {
            ...
            fetch(`https://d-127-1-m-76-doctors-portal-server-nov-18.vercel.app/payments`, {
                method: 'POST',
                headers: {
                    'content-type': 'application/json',
                    authorization: `Bearer ${localStorage.getItem('accessToken')}`
