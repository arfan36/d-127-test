...
const AddDoctor = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch(`https://d-127-1-m-76-doctors-portal-server-nov-18.vercel.app/appointmentSpecialty`);
        ...
        fetch(url, {
            ...
            .then(imgData => {
                ...
                if (imgData.success) {
                    ...
                    fetch(`https://d-127-1-m-76-doctors-portal-server-nov-18.vercel.app/doctors`, {
                        method: 'POST',
                        headers: {
